...
export default function Room() {
  ...
  const isSmall = useMediaQuery(theme.breakpoints.down('lg')) || useMediaQuery(theme.breakpoints.down('md')) || useMediaQuery(theme.breakpoints.down('sm')) || useMediaQuery(theme.breakpoints.down('xs'));
      ...
      >
        ...
        <div className="suites">
          <Grid container spacing={isSmall ? 8 : 3} >
            ...
            <Grid item sm={12} md={12}lg={5.5} order={{sm:2, lg: 1}}>
              <div className="suite-description" style={{ float: "right" }}>
                <h2>Executive Lounge</h2>
                <p>{suitDesc1}</p>
              </div>
            </Grid>
            <Grid item sm={12} md={12} lg={6.5} order={{sm: 1, lg: 2}}>
